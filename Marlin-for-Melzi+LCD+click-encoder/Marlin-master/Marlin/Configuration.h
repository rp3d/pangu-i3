...
#ifndef RP3D_I3 // rp3d.com
#error Uncomment one of #define REPRAPPRO_HUXLEY, REPRAPPRO_MENDEL, or REPRAPPRO_MENDEL2 or RP3D_I3 at the start of the file Configuration.h
#endif
#endif
#endif
#endif
...
#define STRING_VERSION_CONFIG_H "2014-03-11-Chris" //Personal revision number for changes to THIS file.
#define STRING_CONFIG_H_AUTHOR "rp3d.com" //Who made the changes.
...
#ifdef RP3D_I3
#define AXES_MAX_LENGTHS {210, 200, 195}
#define INVERT_X_DIR false    // for Mendel set to false, for Orca set to true
#define INVERT_Y_DIR false    // for Mendel set to true, for Orca set to false
#define INVERT_Z_DIR false    // for Mendel set to false, for Orca set to true
#define INVERT_E0_DIR true   // for direct drive extruder v9 set to true, for geared extruder set to false
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 3200, 137} //RP3D_i3
...
#define ULTIPANEL
  ...
  #define ULTRA_LCD
  #define I2C_LCD
  #define I2C_LCD_ADDR 0x20      //there are 2 kinds LCD,please try 0x27 if this 0x20 do not work.
